                ...
                <div class="col-sm-9">
                    <!-- cart item -->
                        <div class="row border-top py-3 mt-3">
                            ...
                            <div class="col-sm-8">
                                <h5 class="font-baloo font-size-20">Samsung Galaxy Note 20 Ultra</h5>
                            ...
                            <div class="col-sm-2 text-right">
                                <div class="font-size-20 text-danger font-baloo">
                                    <span class="product_price">24.990.000</span>
                                </div>
                            </div>
                        </div>
                    <!-- !cart item -->
                    ...
                    <div class="row border-top py-3 mt-3">
                        ...
                        <div class="col-sm-8">
                            <h5 class="font-baloo font-size-20">Xiaomi Redmi Note 9 Pro</h5>
                        ...
                        <div class="col-sm-2 text-right">
                            <div class="font-size-20 text-danger font-baloo">
                                <span class="product_price">5.990.000</span>
                            </div>
                        </div>
                    </div>
                <!-- !cart item -->
                ...
                <div class="col-sm-3">
                    <div class="sub-total border text-center mt-2">
                        ...
                        <div class="border-top py-4">
                            <h5 class="font-baloo font-size-20">Subtotal (2 item):&nbsp; <span class="text-danger"><span class="text-danger" id="deal-price">30.980.000</span> </span> </h5>
